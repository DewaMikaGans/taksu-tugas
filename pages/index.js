        ...
        <div className="container">
          ...
          <div className="card-content">
            <div className="ui-card">
              <Image src="/post bold throne.jpg" width={300} height={300} />
              <div className="desc">
                <h3>Bold Throne</h3>
                <p>
            ...
            <div className="ui-card">
              <Image src="/post fth.jpg" width={300} height={300} />
              <div className="desc">
            ...
            <div className="ui-card">
              <Image src="/post e kantin.jpg" width={300} height={300} />
              <div className="desc">
          ...
          <div className="container">
            <div className="skill-box">
              <div className="skill-tittle">
                <div className="img">
                  <Image src="/html.png" width={90} height={60} className="skill-icon"></Image>
                </div>
                <h3>HTML</h3>
              </div>
            ...
            <div className="skill-box">
              <div className="skill-tittle">
                <div className="img">
                  <Image src="/css.png" width={90} height={60} className="skill-icon"></Image>
                </div>
                <h3>CSS</h3>
              </div>
            ...
            <div className="skill-box">
              <div className="skill-tittle">
                <div className="img">
                  <Image src="/bootstrap.png" width={90} height={60} className="skill-icon"></Image>
                </div>
                <h3>Bootstrap</h3>
              </div>
            ...
            <div className="skill-box">
              <div className="skill-tittle">
                <div className="img">
                  <Image src="/sd.jpg" width={90} height={60} className="skill-icon"></Image>
                </div>
                <h3>Sekolah Dasar</h3>
              </div>
            ...
            <div className="skill-box">
              <div className="skill-tittle">
                <div className="img">
                  <Image src="/smp.png" width={90} height={50} className="skill-icon"></Image>
                </div>
            ...
            <div className="skill-box">
              <div className="skill-tittle">
                <div className="img">
                  <Image src="/smk ti.png" width={90} height={60} className="skill-icon"></Image>
                </div>
      ...
      <footer id="contact">
        <div className="footer-cnt">
          ...
          <div className="footer-icon">
            <a href="">
              <Image src="/wa.png" width={44} height={44}></Image>
            </a>
            <a href="https://instagram.com/dewaawidhi_?igshid=NDk5N2NlZjQ=x">
              <Image src="/ig.png" width={44} height={44}></Image>
            </a>
            <a href="">
              <Image src="/twt.png" width={44} height={44}></Image>
            </a>
          </div>
        </div>
      </footer>
